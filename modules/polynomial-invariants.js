    ...
    function renderAlexander(el) {
      el.innerHTML =
        ...
        '<div class="expo-panel">' +
          ...
          'are related by <span class="kl-term" title="S-equivalence: the equivalence relation on Seifert matrices generated by conjugation V \u21a6 PVP\u1d40 and stabilization by 2\u00d72 elementary blocks. Two knots have S-equivalent Seifert matrices iff they have the same Alexander module.">S-equivalence</span>, which preserves \\(\\det(V-tV^{\\mathsf{T}})\\) up to units ' +
          '\\(\\pm t^n\\).</p>' +
          '<details class="kl-proof">' +
    ...
    function renderAlexmodule(el) {
      el.innerHTML =
        '<div class="expo-panel">' +
          ...
          'is a <strong><span class="kl-term" title="Z[t,t\u207b\u00b9] module: an abelian group with a compatible action of the Laurent polynomial ring \u039b = Z[t,t\u207b\u00b9]; equivalently a pair (M, t) where t is a Z-linear automorphism of the Z-module M.">\\(\\Lambda\\)-module</span></strong> over the Laurent ring ' +
        ...
        '<div class="expo-panel">' +
          ...
          '<strong><span class="kl-term" title="Lie superalgebra: a Z/2-graded vector space g = g_0 \u2295 g_1 with a bracket [\u00b7,\u00b7] that respects the grading and satisfies super-antisymmetry [x,y] = \u2212(\u22121)^{|x||y|}[y,x] and the super-Jacobi identity.">Lie superalgebra</span></strong>. Before specialising to the Lie case, it pays to review the ' +
          ...
          '<h4><span class="kl-term" title="Z/2-grading: a direct-sum decomposition V = V_0 \u2295 V_1 indexed by the group Z/2 = {0,1}; the two pieces are called even (parity 0) and odd (parity 1).">\\(\\mathbb{Z}/2\\)-grading</span> and parity</h4>' +
          ...
          '</div>' +
          '<p>which differs from the ordinary swap by the <strong><span class="kl-term" title="Koszul sign: the factor (\u22121)^{|v||w|} produced whenever two homogeneous elements of a Z/2-graded structure are exchanged. Controls every sign in super-algebra.">Koszul sign</span></strong>: swapping two odd ' +
          ...
          '<strong><span class="kl-term" title="Super-commutativity: xy = (\u22121)^{|x||y|} yx for homogeneous x, y. Even elements commute with everything; two odd elements anticommute.">super-commutative</span></strong> if</p>' +
          '<div class="formula-box">' +
          ...
          '<ul>' +
            '<li><strong><span class="kl-term" title="Grassmann (exterior) algebra \u039b[\u03b8_1,\u2026,\u03b8_n]: the free super-commutative algebra on n odd generators; equivalently \u2227\u2022V for an n-dimensional V. Underlies differential forms and fermionic state spaces.">Grassmann (exterior) algebra</span></strong> \\(\\Lambda[\\theta_1,\\ldots,\\theta_n]\\): ' +
          ...
          '</ul>' +
          '<p>The <strong><span class="kl-term" title="Supertrace str on End(V_0 \u2295 V_1): tr on the even diagonal block minus tr on the odd diagonal block. The unique trace compatible with the Koszul sign under cyclic permutations.">supertrace</span></strong> on \\(\\mathrm{End}(V)\\) is ' +
      ...
      el.innerHTML =
        ...
        '<div class="expo-panel">' +
          ...
          '<div style="display:flex;align-items:center;justify-content:center;gap:18px;flex-wrap:wrap">' +
            // --- LHS: (R\u2297id)(id\u2297R)(R\u2297id) = \u03c3_1 \u03c3_2 \u03c3_1
            // Strand colours track origin: Red=col1, Blue=col2, Green=col3.
            // LHS crossings:  c1 \u03c3_1 (cols 1,2):  R over B
            //                 c2 \u03c3_2 (cols 2,3):  R over G   (R is now at col 2 after c1)
            //                 c3 \u03c3_1 (cols 1,2):  B over G   (B at col 1, G at col 2 after c2)
            '<svg viewBox="0 0 180 220" width="180" height="220" aria-label="R3 LHS: (R\u2297id)(id\u2297R)(R\u2297id)">' +
              ...
              '<g fill="none" stroke-linecap="round">' +
                // R full path: col1 \u2192 col2 (c1) \u2192 col3 (c2) \u2192 col3 (c3 unaffected)
                '<path d="M20,18 L20,30 C20,45 80,45 80,60 L80,80 C80,95 140,95 140,110 L140,200" stroke="#c0392b" stroke-width="3"/>' +
                // B full path: col2 \u2192 col1 (c1) \u2192 col1 (c2 unaffected) \u2192 col2 (c3)
                '<path d="M80,18 L80,30 C80,45 20,45 20,60 L20,130 C20,145 80,145 80,160 L80,200" stroke="#2e86de" stroke-width="3"/>' +
                // G full path: col3 \u2192 col3 (c1 unaffected) \u2192 col2 (c2) \u2192 col1 (c3)
                '<path d="M140,18 L140,80 C140,95 80,95 80,110 L80,130 C80,145 20,145 20,160 L20,200" stroke="#27ae60" stroke-width="3"/>' +
                // Gaps on under-strands: c1 B under; c2 G under; c3 G under.
                '<line x1="42" y1="42" x2="56" y2="48" stroke="#ffffff" stroke-width="9"/>' +
                '<line x1="102" y1="92" x2="116" y2="98" stroke="#ffffff" stroke-width="9"/>' +
                '<line x1="42" y1="142" x2="56" y2="148" stroke="#ffffff" stroke-width="9"/>' +
                // Redraw over-strand fragments (thicker) on top of gaps.
                '<path d="M20,30 C20,45 80,45 80,60" stroke="#c0392b" stroke-width="4.5"/>' +
                '<path d="M80,80 C80,95 140,95 140,110" stroke="#c0392b" stroke-width="4.5"/>' +
                '<path d="M20,130 C20,145 80,145 80,160" stroke="#2e86de" stroke-width="4.5"/>' +
              '</g>' +
              '<text x="90" y="214" text-anchor="middle" font-size="10" fill="#555">(R\u2297id)(id\u2297R)(R\u2297id)</text>' +
            '</svg>' +
            '<span style="font-size:1.6em">\\(=\\)</span>' +
            // --- RHS: (id\u2297R)(R\u2297id)(id\u2297R) = \u03c3_2 \u03c3_1 \u03c3_2
            // c1 \u03c3_2 (cols 2,3): B over G   (B at col 2, G at col 3)
            // c2 \u03c3_1 (cols 1,2): R over G   (G is now at col 2 after c1; R still at col 1)
            // c3 \u03c3_2 (cols 2,3): R over B   (R is at col 2 after c2; B is at col 3)
            '<svg viewBox="0 0 180 220" width="180" height="220" aria-label="R3 RHS: (id\u2297R)(R\u2297id)(id\u2297R)">' +
              '<text x="20"  y="12" font-size="11" fill="#333" text-anchor="middle">1</text>' +
              '<text x="80"  y="12" font-size="11" fill="#333" text-anchor="middle">2</text>' +
              '<text x="140" y="12" font-size="11" fill="#333" text-anchor="middle">3</text>' +
              '<g fill="none" stroke-linecap="round">' +
                // R full path: col1 \u2192 col1 (c1 unaffected) \u2192 col2 (c2) \u2192 col3 (c3)
                '<path d="M20,18 L20,80 C20,95 80,95 80,110 L80,130 C80,145 140,145 140,160 L140,200" stroke="#c0392b" stroke-width="3"/>' +
                // B full path: col2 \u2192 col3 (c1) \u2192 col3 (c2 unaffected) \u2192 col2 (c3)
                '<path d="M80,18 L80,30 C80,45 140,45 140,60 L140,130 C140,145 80,145 80,160 L80,200" stroke="#2e86de" stroke-width="3"/>' +
                // G full path: col3 \u2192 col2 (c1) \u2192 col1 (c2) \u2192 col1 (c3 unaffected)
                '<path d="M140,18 L140,30 C140,45 80,45 80,60 L80,80 C80,95 20,95 20,110 L20,200" stroke="#27ae60" stroke-width="3"/>' +
                // Gaps: c1 G under; c2 G under; c3 B under.
                '<line x1="102" y1="42" x2="116" y2="48" stroke="#ffffff" stroke-width="9"/>' +
                '<line x1="42" y1="92" x2="56" y2="98" stroke="#ffffff" stroke-width="9"/>' +
                '<line x1="102" y1="142" x2="116" y2="148" stroke="#ffffff" stroke-width="9"/>' +
                // Redraw over-strand fragments on top.
                '<path d="M80,30 C80,45 140,45 140,60" stroke="#2e86de" stroke-width="4.5"/>' +
                '<path d="M20,80 C20,95 80,95 80,110" stroke="#c0392b" stroke-width="4.5"/>' +
                '<path d="M80,130 C80,145 140,145 140,160" stroke="#c0392b" stroke-width="4.5"/>' +
              '</g>' +
              '<text x="90" y="214" text-anchor="middle" font-size="10" fill="#555">(id\u2297R)(R\u2297id)(id\u2297R)</text>' +
            '</svg>' +
          '</div>' +
